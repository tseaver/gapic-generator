...
require "google/cloud/showcase/v1/credentials"
      ...
      module V1
        ...
        class ShowcaseClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::Showcase::V1::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::Showcase::V1::Credentials.new(credentials).updater_proc
            end
            ...
            package_version = Gem.loaded_specs['google-cloud-showcase'].version.version
          ...
          # @example
          #   require "google/cloud/showcase/v1"
          #
          #   showcase_client = Google::Cloud::Showcase::V1.new
